...
#' For description of the variables see \url{https://www.ngdc.noaa.gov/nndc/struts/results?&t=101650&s=225&d=225}
#'
#' @format A data frame with 5984 rows and 47 variables:
#' \describe{
#'           \item{I_D}{}
#'           \item{FLAG_TSUNAMI}{}
#'           \item{YEAR}{}
